...
static void case_for_echo(char *c, char arg, t_echo *echo_flags, int* j) {
    switch (*c = arg) {
                    case 'a': *c = '\a'; j+= 1;  break;
                    case 'b': *c = '\b'; j+= 1; break;
                    case 'c': ; echo_flags->n = 3; return ;
                    case 'e': *c = '\x1B'; j+= 1; break;
                    case 'f': *c = '\f'; j+= 1; break;
                    case 'n': *c = '\n'; j+= 1; break;
                    case 'r': *c = '\r'; j+= 1; break;
                    case 't': *c = '\t'; j+= 1; break;
                    case 'v': *c = '\v'; j+= 1; break;
                }
}
